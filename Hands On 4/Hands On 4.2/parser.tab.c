...
#line 50 "parser.y"
                           {
      if (!existe((yyvsp[-3].str)) || !existe((yyvsp[-1].str)))         // Verifica existencia de los identificadores
        printf("Error: identificador no declarado\n");
      else if (buscar_tipo((yyvsp[-3].str)) != buscar_tipo((yyvsp[-1].str))) // Verifica que sean del mismo tipo
...
#line 56 "parser.y"
                                        {
      if (!existe((yyvsp[-3].str)) || !existe((yyvsp[-1].str)))         // Casos sucesivos de asignación
        printf("Error: identificador no declarado\n");
